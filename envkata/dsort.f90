...
!! Date: 2004-03-01  Time: 20:26:22
!! ORIGIN IS:
!! http://www.netlib.org/slatec/src/
!!@author  Jones, R. E., (SNLA),Wisniewski, J. A., (SNLA)
!!>======================================================================
...
CHARACTER (LEN=*), INTENT(IN OUT)        :: librar
CHARACTER (LEN=*), INTENT(IN OUT)        :: subrou
CHARACTER (LEN=*), INTENT(IN OUT)        :: messg
INTEGER, INTENT(IN OUT)                  :: nerr
INTEGER, INTENT(IN OUT)                  :: level
INTEGER, INTENT(IN OUT)                  :: kontrl
...
INTEGER, INTENT(IN)                      :: npref
CHARACTER (LEN=*), INTENT(IN)            :: messg
INTEGER, INTENT(IN OUT)                  :: nwrap
...
!        OR ELSE DETERMINE THAT THE ERROR TABLE IS FULL.
  ...
  DO  i = 1,nmsg
    IF (lib == libtab(i) .AND. sub == subtab(i) .AND.  &
          mes == mestab(i) .AND. nerr == nertab(i) .AND. level == levtab(i)) THEN
      kount(i) = kount(i) + 1
      icount = kount(i)
      RETURN
    END IF
