...
! VARIABLES DECLARATION
  ...
  ! general variables
  integer :: jaa, jbb, jcc, j, k, l, dummy
  integer, parameter :: mesh = 5
  ...
  real(8) :: aa = 0.8, bb = 1.6, cc = 0.4
  real(8) :: aamax, aamin, bbmax, bbmin, ccmax, ccmin
...
! DATA PROCESSING
  ...
  aamin = aa - 0.1d0; aamax = aa + 0.1d0
  bbmin = bb - 0.1d0; bbmax = bb + 0.1d0
  ccmin = cc - 0.1d0; ccmax = cc + 0.1d0

  ! initialization
  aa = aamin
  bb = bbmin
  cc = ccmin
  open(3,file="meshhatamod.dat")
  do jaa = 1, 5
     do jbb = 1, 5
        do jcc = 1, 5
           ...
           do j = 1, mesh+1
              do k = 1, mesh+1
                 ...
                 do l = 1, nlinei
                    ...
                    ! 10 = errorbar
                    Reval = Reval + (1000*(Eexp(l) - Ecal(l))/10)**2
                 end do
                 write(3,"(5f7.3,f12.3)"), aa, bb, cc, cex, ck, Reval
